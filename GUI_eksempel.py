...
ttk.Button(etasje_2_rom_1, text='Oppdater').grid(column=0, row=6)      # Start stop og avslutt knapp
ttk.Button(etasje_2_rom_1, text='Start').grid(column=0, row=7)
ttk.Button(etasje_2_rom_1, text='Stopp').grid(column=0, row=8)
